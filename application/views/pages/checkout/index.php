                    ...
                    <div class="card-body">
                        <form action="<?= base_url("/checkout/create") ?>" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" placeholder="Masukkan nama penerima"
                                    value="<?= $input->name ?>" class="form-control">
                                <?= form_error('name') ?>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="address" cols="30" rows="10"
                                    id="address"><?= $input->address ?></textarea>
                                <?= form_error('address') ?>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" id="phone" placeholder="Masukkan nomor telepon"
                                    value="<?= $input->phone ?>" class="form-control">
                                <?= form_error('phone') ?>
                            </div>
